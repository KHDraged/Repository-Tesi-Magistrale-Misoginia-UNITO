...
# Carica i dataset
train_file_raw = 'haspeede2_reference_taskAB-tweets_anon_revised.tsv'
...
# Creazione dataset
train_dataset_raw = HateSpeechDataset(train_data_raw['full_text'].values, train_data_raw['hs'].values, tokenizer)
